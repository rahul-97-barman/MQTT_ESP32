...
const char* password = "rahulproject123"; // Setting your AP PSK
const char* mqttServer = "broker.hivemq.com";
const char* mqttUserName = "rahulproject";
const char* mqttPwd = "rahulproject123";
const char* clientID = "rahulproject01"; // Client ID username+0001
